    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-2xl mx-auto mb-12 -mt-8 z-20 px-4 sm:px-0">
          <div className="bg-white rounded-full shadow-xl flex items-center p-1.5 sm:p-2 border border-gray-100 focus-within:ring-2 focus-within:ring-primary focus-within:border-transparent transition-all">
            ...
            />
            <button className="text-gray-400 hover:text-primary p-1 sm:p-2 mr-1 sm:mr-2 transition shrink-0" aria-label="Voice Search">
              <FiMic className="w-4 h-4 sm:w-5 sm:h-5" />
            </button>
            <button className="bg-primary hover:bg-primary-dark text-white font-bold py-2 sm:py-3 px-4 sm:px-8 rounded-full shadow-md transition shrink-0 text-sm sm:text-base">
              Search
            </button>
          </div>
        </div>
